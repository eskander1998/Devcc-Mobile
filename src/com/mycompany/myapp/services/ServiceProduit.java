...
public class ServiceProduit {
    ...
    public boolean addProduit(Produit prod, int quant, String email) {
        String url = Statics.BASE_URL + "/produits/shopJSON/add?email="+ email +"&idProduit=" + prod.getID_Produit() + "&Quant=" + quant + "&Prix=" + prod.getPrix(); //création de l'URL
    ...
    public ArrayList<Produit> getProduitsByPage(int page){
        String url = Statics.BASE_URL+"/produits/afficherproduitsJSON?page="+page;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public ArrayList<Promotion> getAllPromos(){
        String url = Statics.BASE_URL+"/produits/AllPromos";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
