...
public class ServiceCommande {
    ...
    public boolean modifierCommande(Commande com) {
        String url = Statics.BASE_URL + "/ZenLife/public/index.php/front/updateJSON/update?idCommande=" + com.getID_Commande() + "&Quant=" + com.getQuantitee(); //création de l'URL
    ...
    public boolean supprimerCommande(Commande com) {
        String url = Statics.BASE_URL + "/ZenLife/public/index.php/front/deleteJSON/delete?idCommande=" + com.getID_Commande(); //création de l'URL
        req.setUrl(url);// Insertion de l'URL de notre demande de connexion
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
