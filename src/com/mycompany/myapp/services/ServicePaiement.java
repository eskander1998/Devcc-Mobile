...
public class ServicePaiement {
    ...
    public ArrayList<Payment> addPaiement(String ModePayment,String email) {
        String url = Statics.BASE_URL + "/front/PaiementJSON/add?email="+ email +"&ModePay=" + ModePayment; //création de l'URL
