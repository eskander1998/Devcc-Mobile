...
//            {
                          Button part=new Button("Reservé");
                                                    Button empalacement=new Button("Emplacement");
                                                                                                        Button empalacement1=new Button("Emplacement1");


            
          //      part.addActionListener(e -> new Ajouterreservation(c.getId()).show());
                          
 empalacement.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                
 for ( int i=0;i<ServiceThe.getInstance().getAllThess().size();i++)
              
          {            if (c.getIdtherapeute()==ServiceThe.getInstance().getAllThess().get(i).getId())
          { User.i1=i;break;}

              break;
              }
                System.out.println(ServiceThe.getInstance().getAllThess().get(User.i1).getLat());  
                                System.out.println(ServiceThe.getInstance().getAllThess().get(User.i1).getLng());   //System.out.println(ServiceThe.getInstance().getAllThess().get(i).getId());
//System.out.println(ServiceThe.getInstance().getAllThess().get(i).getId());
                ...
                empalacement1.addActionListener(e ->new FormMap(ServiceThe.getInstance().getAllThess().get(User.i1).getLat(),ServiceThe.getInstance().getAllThess().get(User.i1).getLng()).show());
                //System.out.println(ServiceThe.getInstance().getThe(11).get(0).getId());
                

            c1.add(part);
c1.add(empalacement);
c1.add(empalacement1);
