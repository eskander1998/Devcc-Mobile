...
public class FacebookShare extends ShareService {
    ...
    private String token="EAAK9nssgZAZBEBANrnMJnKV4qL6cFP36cGPxrRJg3T9sE3sFJhTVyEQVokyuyMu2ZCWanF3ESpq5WWO9TU0BotkdLXKj3ZAUPFmnRcUDAizRFHmafZA6HBZAhxXxKAUj8oMZBwtZC0ZBeZCaByw8538PburVsDuW8uIfxZBafurqCTKzRRmo4ZAkSbJBRJ7jMFyZChPiJOoaBc3ZA2UC8EOSmu6gTR";
    ...
    public Image getIcon() {
        ...
        if(i == null) {
            i = Resources.getSystemResource().getImage("affiche.png");
            setIcon(i);
        }
        return i;
    }
            ...
            f[0] = new ShareForm(getOriginal(), "Post on My Wall", null, text, image,
                    new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent evt) {
                            ...
                            final String endpoint = "https://graph.facebook.com/me/photos?access_token=" + "EAAK9nssgZAZBEBANrnMJnKV4qL6cFP36cGPxrRJg3T9sE3sFJhTVyEQVokyuyMu2ZCWanF3ESpq5WWO9TU0BotkdLXKj3ZAUPFmnRcUDAizRFHmafZA6HBZAhxXxKAUj8oMZBwtZC0ZBeZCaByw8538PburVsDuW8uIfxZBafurqCTKzRRmo4ZAkSbJBRJ7jMFyZChPiJOoaBc3ZA2UC8EOSmu6gTR";
                            req.setUrl(endpoint);
